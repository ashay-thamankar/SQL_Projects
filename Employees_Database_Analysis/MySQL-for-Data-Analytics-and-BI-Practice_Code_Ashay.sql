...
###########
-- TOPIC: Creating a Database - Part I
...
###########
-- TOPIC: Creating a Database - Part II
...
###########
-- TOPIC: Fixed and Floating-Point Data Types
...
###########
-- TOPIC: Using Databases and Tables
...
###########
-- TOPIC: Additional Notes on Using Tables
...
###########
-- TOPIC: FOREIGN KEY Constraint - Part I
...
###########
-- TOPIC: FOREIGN KEY Constraint - Part II
...
###########
-- TOPIC: NOT NULL Constraint - Part I
...
###########
-- TOPIC: Coding Techniques and Best Practices - Part II
...
###########
-- TOPIC: Loading the 'employees' Database
...
###########
-- TOPIC: Other Comparison Operators
...
###########
-- TOPIC: Introduction to Aggregate Functions    
...
###########
-- TOPIC: The INSERT Statement - Part I
...
###########
-- TOPIC: The INSERT Statement - Part II
...
###########
-- TOPIC: Inserting Data INTO a New Table
...
###########
-- TOPIC: The UPDATE Statement - Part I
...
###########
-- TOPIC: The UPDATE Statement - Part II
...
###########
-- TOPIC: The DELETE Statement - Part I
...
###########
-- TOPIC: The DELETE Statement - Part II
...
###########
-- TOPIC: Another Example of Using COALESCE()
...
###########
-- TOPIC: The New and the Old Join Syntax
...
###########
-- TOPIC: JOIN and WHERE Used Together
...
###########
-- TOPIC: Using Aggregate Functions with Joins
...
###########
-- TOPIC: Join more than Two Tables in SQL
...
###########
-- TOPIC: Tips and Tricks for Joins
...
###########
-- TOPIC: Subqueries with IN nested inside WHERE
...
###########
-- TOPIC: Subqueries with EXISTS-NOT EXISTS nested inside WHERE
...
###########
-- TOPIC: Subqueries nested in SELECT and FROM
...
###########
-- TOPIC: The MySQL Syntax for Stored Procedures

USE employees;


###########
-- TOPIC: Stored Procedures - Example - Part I
...
###########
-- TOPIC: Stored Procedures - Example - Part II
...
###########
-- TOPIC: Another Way to Create a Procedure in MySQL

DROP PROCEDURE select_employees;


###########
-- TOPIC: Stored Procedures with an Input Parameter
...
###########
-- TOPIC: Stored Procedures with an Output Parameter
...
###########
-- TOPIC: User-Defined Functions in MySQL
...
###########
-- TOPIC: Stored Routines - Conclusion
...
###########
-- TOPIC: Types of MySQL Variables - Local Variables
...
###########
-- TOPIC: User-Defined vs System Variables
...
###########
-- TOPIC: The ROW_NUMBER() Ranking Window Function and the Relevant MySQL Syntax
...
-- EXERCISE 1: The ROW_NUMBER() Ranking Window Function and the Relevant MySQL Syntax
SELECT 
	emp_no, 
    dept_no,
...
-- EXERCISE 2: The ROW_NUMBER() Ranking Window Function and the Relevant MySQL Syntax
SELECT 
	emp_no, 
	first_name, 
	last_name,
...
###########
-- TOPIC: A Note on Using Several Window Functions in a Query
...
-- EXERCISE 1: A Note on Using Several Window Functions in a Query
SELECT 
	dm.emp_no, 
    salary, 
    ROW_NUMBER() OVER () AS row_num1,
...
-- EXERCISE 2: A Note on Using Several Window Functions in a Query
SELECT 
	dm.emp_no, 
    salary, 
...
###########
-- TOPIC: MySQL Window Functions Syntax
...
-- EXERCISE 1: MySQL Window Functions Syntax
SELECT 
	emp_no, 
	first_name, 
	ROW_NUMBER() OVER w AS row_num
...
###########
-- TOPIC: The PARTITION BY Clause VS the GROUP BY Clause
...
-- EXERCISE 1: The PARTITION BY Clause VS the GROUP BY Clause
SELECT a.emp_no, 
...
-- EXERCISE 2: The PARTITION BY Clause VS the GROUP BY Clause
SELECT a.emp_no, 
       MIN(salary) AS min_salary FROM (
	SELECT 
...
-- EXERCISE 3: The PARTITION BY Clause VS the GROUP BY Clause
SELECT 
...
-- EXERCISE 4: The PARTITION BY Clause VS the GROUP BY Clause
SELECT a.emp_no, 
...
-- EXERCISE 5: The PARTITION BY Clause VS the GROUP BY Clause
SELECT a.emp_no, 
	a.salary as min_salary FROM (
	SELECT 
		emp_no, salary, ROW_NUMBER() OVER w AS row_num
...
###########
-- TOPIC: The MySQL RANK() and DENSE_RANK() Window Functions
...
-- EXERCISE 1: The MySQL RANK() and DENSE_RANK() Window Functions
SELECT 
	emp_no, 
	salary,
	ROW_NUMBER() OVER w AS row_num
...
-- EXERCISE 2: The MySQL RANK() and DENSE_RANK() Window Functions
SELECT 
...
-- EXERCISE 3: The MySQL RANK() and DENSE_RANK() Window Functions
SELECT 
	emp_no, 
	salary,
...
-- EXERCISE 4: The MySQL RANK() and DENSE_RANK() Window Functions
SELECT 
	emp_no, 
	salary,
...
###########
-- TOPIC: Working with MySQL Ranking Window Functions and Joins Together
...
-- EXERCISE 1: Working with MySQL Ranking Window Functions and Joins Together
SELECT 
    e.emp_no,
...
-- EXERCISE 2: Working with MySQL Ranking Window Functions and Joins Together
SELECT 
    e.emp_no,
...
###########
-- TOPIC: The LAG() and LEAD() Value Window Functions
...
-- EXERCISE 1: The LAG() and LEAD() Value Window Functions
SELECT 
	emp_no,
    salary, 
    LAG(salary) OVER w AS previous_salary,
...
-- EXERCISE 2: The LAG() and LEAD() Value Window Functions
SELECT 
	emp_no,
    salary, 
    LAG(salary) OVER w AS previous_salary,
...
###########
-- TOPIC: MySQL Aggregate Functions in the Context of Window Functions - Part I
...
-- EXERCISE 1: MySQL Aggregate Functions in the Context of Window Functions - Part I
SELECT 
    s1.emp_no, s.salary, s.from_date, s.to_date
FROM
    salaries s
...
###########
-- TOPIC: MySQL Aggregate Functions in the Context of Window Functions - Part II
...
-- EXERCISE 1: MySQL Aggregate Functions in the Context of Window Functions - Part II
SELECT 
    de2.emp_no, d.dept_name, s2.salary, AVG(s2.salary) OVER w AS average_salary_per_department
FROM
    (SELECT 
...
-- SECTION: SQL Common Table Expressions
...
###########
-- TOPIC: MySQL Common Table Expressions - Introduction
USE employees;
...
###########
-- TOPIC: An Alternative Solution to the Same Task-Exercise
USE employees;
...
-- EXERCISE 1: An Alternative Solution to the Same Task-Exercise
	WITH cte1 AS (
	SELECT AVG(salary) AS avg_salary FROM salaries
	),
...
-- EXERCISE 2: An Alternative Solution to the Same Task-Exercise
WITH cte AS (
SELECT AVG(salary) AS avg_salary FROM salaries
)
SELECT
...
-- EXERCISE 3: An Alternative Solution to the Same Task-Exercise
SELECT 
    SUM(CASE
        WHEN s.salary < a.avg_salary THEN 1
        ELSE 0
...
-- EXERCISE 4: An Alternative Solution to the Same Task-Exercise
WITH cte AS (
SELECT AVG(salary) AS avg_salary FROM salaries
)
SELECT
...
###########
-- TOPIC: Using Multiple Subclauses in a WITH Clause
-- Part I
...
-- EXERCISE 1: Using Multiple Subclauses in a WITH Clause
WITH cte1 AS (
SELECT AVG(salary) AS avg_salary FROM salaries
),
cte2 AS (
...
-- EXERCISE 2: Using Multiple Subclauses in a WITH Clause
WITH cte_avg_salary AS (
SELECT AVG(salary) AS avg_salary FROM salaries
),
...
-- EXERCISE 3: Using Multiple Subclauses in a WITH Clause
WITH cte_avg_salary AS (
SELECT AVG(salary) AS avg_salary FROM salaries
),
cte_m_highest_salary AS (
...
###########
-- TOPIC: Referring to Common Table Expressions in a WITH Clause
USE employees;
...
###########
-- TOPIC: MySQL Temporary Tables in Action
USE employees;
...
-- EXERCISE 1: MySQL Temporary Tables in Action
...
-- EXERCISE 2: MySQL Temporary Tables in Action
SELECT 
    *
FROM
    male_max_salaries;
...
###########
-- TOPIC: Other Features of MySQL Temporary Tables
USE employees;
...
-- EXERCISE 1: Other Features of MySQL Temporary Tables
CREATE TEMPORARY TABLE dates
SELECT 
    NOW(),
...
-- EXERCISE 2: Other Features of MySQL Temporary Tables
SELECT 
    *
FROM
    dates dates;
    
-- EXERCISE 3: Other Features of MySQL Temporary Tables
WITH cte AS (SELECT 
    NOW(),
...
-- EXERCISE 4: Other Features of MySQL Temporary Tables
WITH cte AS (SELECT 
    NOW(),
...
-- EXERCISE 5: Other Features of MySQL Temporary Tables
